...
namespace Ludo
{
    class Green : PictureBox
    {
        ...
        public void Movement(int RandomNumber,  int[]arr , ref int KilledGoti, PictureBox Goti)
        {
            ...
            if (IsFree)
            {
                ...
                {
                    if (arr[NoOfMoves+1] != color && arr[NoOfMoves+1] != 0)
                    {
                    ...
                    {
                        Goti.Location = new Point(Goti.Location.X + 34, Goti.Location.Y + 20);
                        NoOfMoves++;
                    }
