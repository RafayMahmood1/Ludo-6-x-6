        ...
        public void Movement(int RandomNumber, ref int[] arr, ref int KilledGoti, PictureBox Goti)
        {
            ...
            if (IsFree)
            {
                for (int i = 0; i < RandomNumber; i++)
                {
                    ...
                    {
                        if (arr[NoOfMoves + 39 + 1] != color && arr[NoOfMoves + 39 + 1] != 0)
                        {
                            if (NoOfMoves + 1 == 0 || NoOfMoves + 1 == 13 || NoOfMoves + 1 == 26 || NoOfMoves + 1 == 39 || NoOfMoves + 52 == 0 || NoOfMoves + 1 == 65)
                            {
                                KilledGoti = 0;
                    ...
                    {
                        Goti.Location = new Point(Goti.Location.X - 20, Goti.Location.Y - 31);
                        NoOfMoves++;
                    }
                    ...
                    {
                        Goti.Location = new Point(Goti.Location.X + 0, Goti.Location.Y - 52);
                        NoOfMoves++;
                    }
                    ...
                    arr[NoOfMoves + 52] = color;
                    arr[NoOfMoves + 52 - 1] = 0;
                    if (NoOfMoves + 52 > 77)
                    {
                        arr[Continue] = color;
                        if (Continue == 0)
