        ...
        public void Movement(int RandomNumber, ref int[] arr, ref int KilledGoti, PictureBox Goti)
        {
            ...
            if (IsFree)
            {
                for (int i = 0; i < RandomNumber; i++)
                {
                    ...
                    {
                        if (arr[NoOfMoves + 65 + 1] != color && arr[NoOfMoves + 65 + 1] != 0)
                        {
                            if (NoOfMoves + 1 == 0 || NoOfMoves + 1 == 13 || NoOfMoves + 1 == 26 || NoOfMoves + 1 == 39 || NoOfMoves + 52 == 0 || NoOfMoves + 1 == 65)
                            {
                                KilledGoti = 0;
                    ...
                    else if ((NoOfMoves > 4 && NoOfMoves <= 9) || (NoOfMoves > 50 && NoOfMoves <= 55))
                    {
                        if (NoOfMoves == 51)
                        {
                            Goti.Location = new Point(367, 44);
                            Goti.Location.Offset(367, 44);
                        }
                        else
                        {
                    ...
                    {
                        Goti.Location = new Point(Goti.Location.X - 25, Goti.Location.Y - 34);
                        NoOfMoves++;
                    }
                    ...
                    else if (NoOfMoves > 37 && NoOfMoves <= 42 || NoOfMoves > 69 && NoOfMoves <= 74)
                    {
                        if (NoOfMoves == 38)
                        {
                            Goti.Location = new Point(100, 144);
                            Goti.Location.Offset(100, 144);
                        }
                        else
                        {
                    ...
                    {
                        Goti.Location = new Point(Goti.Location.X - 35, Goti.Location.Y - 18);
                        NoOfMoves++;
                    }
                    ...
                    arr[NoOfMoves + 39] = color;
                    arr[NoOfMoves + 39 - 1] = 0;
                    if (NoOfMoves + 39 > 77)
                    {
                        arr[Continue] = color;
                        if (Continue == 0)
